/*
 * package com.vimco.ecommerce.config.documentation;
 * 
 * 
 ...
 * 
 * private ApiInfo getApiInfo() { Contact contact = new Contact("webtutsplus",
 * "http://webtutsplus.com", "contact.webtutsplus@gmail.com"); return new
